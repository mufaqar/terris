    ...
    <>
      <section>
        <div className="container md:w-7/12 w-full mx-auto pb-[9px] px-2">
          <div className="">
            <h3 className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskMeduim">{project.title}</h3>
            <p className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular">{project?.tag}</p>
        ...
        <div className="container w-full px-2 mx-auto gallery md:w-7/12">
          <div className="grid gap-[9px]">
            <OwnImage path={project.featureimage.asset.url} alt={project.featureimage?.caption ? project.featureimage?.caption : project.title} />
            {
              project.gallery.images.map((image, index) => (
                <OwnImage path={image.asset.url} alt={image?.caption ? image?.caption : project.title} key={index} />
              ))
            }
          </div>
        </div>
        ...
        <div className="container md:w-7/12 w-full mx-auto pt-[9px] px-2  grid gap-7">
          <ul className="">
            <li className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular">{project?.location}</li>
            <li className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular">{project?.year}</li>
            <li className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular">{project?.area}</li>
          </ul>
          ...
          <ul className="">
            <li className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskMeduim">Project highlights</li>
            {
              project.project_highlights.map((highlight, index) => (
                <li key={index} className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular">
                  {highlight}
                </li>
              ))
            }
          ...
          <ul className="">
...

            {
              project.featured_in.map((feturedin, index) => (
                <li key={index} className="lg:text-[1.063rem] lg:leading-[1.375rem] md:text-[0.938rem] md:leading-[1.25rem] text-[0.813rem] leading-[1.125rem] font-AtlasGroteskRegular underline hover:no-underline">
                  <a
                    href={feturedin?.link}
                    target="_blank"
                    rel="noreferrer"
