            ...
            <section>
                ...
                <div className='container w-full px-2 pb-10 mx-auto md:w-7/12'>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-[9px]">
                        {
                            team.filter((team) => team.categories === "Senior Project Management").map((senior_team, index) => (
                                <TeamBox key={index} name={senior_team.name} detail={senior_team.detail} categorie={senior_team.categories} id={senior_team._id} imgPath={senior_team.featureimage} teamState={stateChange} teamOpen={teamOpen}/>
                            ))
                        }
                    </div>
                </div>
                ...
                <div className='container w-full px-2 pb-10 mx-auto md:w-7/12'>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-[9px]">
                        {
                            team.filter((team) => team.categories === "Junior Site Management").map((junior_team, index) => (
                                <TeamBox key={index} name={junior_team.name} detail={junior_team.detail} categorie={junior_team.categories} imgPath={junior_team.featureimage} id={junior_team._id} teamState={stateChange} teamOpen={teamOpen}/>
                            ))
                        }
                    </div>
                </div>
                ...
                <div className='container w-full px-2 pb-10 mx-auto md:w-7/12'>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-[9px]">
                        {
                            team.filter((team) => team.categories === "Carpentry").map((carpentry_team, index) => (
                                <TeamBox key={index} name={carpentry_team.name} detail={carpentry_team.detail} categorie={carpentry_team.categories} imgPath={carpentry_team.featureimage} id={carpentry_team._id} teamState={stateChange} teamOpen={teamOpen}/>
                            ))
                        }
                    </div>
                </div>
                ...
                <div className='container w-full px-2 pb-10 mx-auto md:w-7/12'>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-[9px]">
                        {
                            team.filter((team) => team.categories === "Office").map((office_team, index) => (
                                <TeamBox key={index} name={office_team.name} detail={office_team.detail} categorie={office_team.categories} imgPath={office_team.featureimage} id={office_team._id} teamState={stateChange} teamOpen={teamOpen}/>
                            ))
                        }
                    </div>
                </div>
